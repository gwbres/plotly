...
pub struct ScatterGeo<Lat, Lon>
where
    Lat: Serialize + Clone,
    Lon: Serialize + Clone,
{
    #[field_setter(default = "PlotType::ScatterGeo")]
    r#type: PlotType,
...
impl<Lat, Lon> ScatterGeo<Lat, Lon>
where
...
impl<Lat, Lon> Trace for ScatterGeo<Lat, Lon>
where
    Lat: Serialize + Clone,
    Lon: Serialize + Clone,
{
...
mod tests {
    ...
    #[test]
    fn test_serialize_scattergeo() {
        let scatter = ScatterGeo::new(vec![45.5017], vec![-73.5673])
            .name("name")
